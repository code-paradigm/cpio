...
export const headerPlugin = 'headerPlugin';

async function headerFunctionPlugin(dom: JSDOM, route: HandledRoute): Promise<JSDOM> {
...
registerPlugin('postProcessByDom', headerPlugin, headerFunctionPlugin, validator);
